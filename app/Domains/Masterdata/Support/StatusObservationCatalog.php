...
class StatusObservationCatalog
{
    ...
    public static function all(): array
    {
        return [
            ...
            'harnableitung' => [
                'label' => 'Harnableitung', 'section' => 'Kontinenz', 'kind' => 'coded_insertion_date',
                'code' => ['406219008', 'Harnableitung'],
                'profile' => 'Observation_Urinary_Drainage', 'slice' => 'harnableitung',
                'fhir_code' => ['406219008', 'Urinary elimination status (observable entity)'],
                'options' => [
                    '302113004' => 'Urostoma',
                    '440311000' => 'suprapubischer Dauerkatheter',
                    '404684003:47429007=34759008,363713009=52101004' => 'transurethraler Dauerkatheter',
                    '404684003:47429007=236240005' => 'intermittierender Selbstkatheterismus',
                    '404684003:47429007=414846002,363713009=52101004' => 'Nephrostomie',
                ],
                'value_displays' => [
                    '302113004' => 'Urostomy present (finding)',
                    '440311000' => 'Suprapubic urinary catheter in situ (finding)',
                    '404684003:47429007=34759008,363713009=52101004' => 'Clinical finding (finding) : Associated with (attribute) = Urethral catheter, device (physical object) , Has interpretation (attribute) = Present (qualifier value)',
                    '404684003:47429007=236240005' => 'Clinical finding (finding) : Associated with (attribute) = Clean intermittent self-catheterization (procedure)',
                    '404684003:47429007=414846002,363713009=52101004' => 'Clinical finding (finding) : Associated with (attribute) = Nephrostomy system (physical object) , Has interpretation (attribute) = Present (qualifier value)',
                ],
            ],
            'stuhlableitung' => [
                'label' => 'Stuhlableitung', 'section' => 'Kontinenz', 'kind' => 'coded_insertion_date',
                'code' => ['363787002:704321009=266683002', 'Stuhlableitung'],
                'profile' => 'Observation_Fecal_Drainage', 'slice' => 'stuhlableitung',
                'fhir_code' => ['363787002:704321009=266683002', 'Observable entity (observable entity) : Characterizes (attribute) = Evacuation of gastrointestinal tract contents (procedure)'],
                'options' => [
                    '302112009' => 'Kolostoma',
                    '302111002' => 'Ileostoma',
                    '404684003:47429007=313280002' => 'manuelle Ausräumung',
                    '404684003:47429007=787802002' => 'Darmrohr',
                    '404684003:47429007=266683002' => 'Darmentleerung (sonstige)',
                ],
                'value_displays' => [
                    '302112009' => 'Colostomy present (finding)',
                    '302111002' => 'Ileostomy present (finding)',
                    '404684003:47429007=313280002' => 'Clinical finding (finding) : Associated with (attribute) = Manual evacuation of feces from rectum (procedure)',
                    '404684003:47429007=787802002' => 'Clinical finding (finding) : Associated with (attribute) = Insertion of flatus tube into rectum (procedure)',
